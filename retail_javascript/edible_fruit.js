if (window.location.pathname.includes('edible_fruit.html')) {
// This script will automatically run when you reach edible_fruit.html
...
function fetchDataFromServer() {
    ...
    fetch('http://localhost:8443/edible_fruit')  // Replace with your actual endpoint
