document.getElementById("search_form").addEventListener("submit", 
    function(event)
    {
            var name_fruit = document.getElementById("name_vegetable");
            var variety_fruit = document.getElementById("variety_vegetable");
            var latin_name_fruit = document.getElementById("latin_name_vegetable");
    ...
    document.getElementById("search_form").addEventListener("submit", function(event) {
        ...
        fetch(`http://localhost:8443/edible_vegetable?${queryParams}`)
