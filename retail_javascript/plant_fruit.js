if (window.location.pathname.includes('plant_fruit.html')) {
...
function fetchDataFromServer() {
    ...
    fetch('http://localhost:8443/plant_fruit')  // Replace with your actual endpoint
        ...
        .then(data => {
            ...
            if (data.length === 0) {
                ...
                // Load HTML template
                fetch('../retail_html/result_plant_fruit_template.html')
