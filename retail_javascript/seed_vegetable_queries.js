document.getElementById("search_form").addEventListener("submit", 
    function(event)
    {
            ...
            var origine_seed = document.getElementById("origine_seed");
            var price_seed = document.getElementById("price_seed");
            ...
            if (origine_seed.value === "")
            {
                    origine_seed.value = "NULL";
            }
            if (price_seed.value === "")
            {
                    price_seed.value = "NULL";
            }
    ...
    document.getElementById("search_form").addEventListener("submit", function(event) {
        ...
        fetch(`http://localhost:8443/seed_vegetable?${queryParams}`)
            ...
            .then(data => {
                ...
                if (data.length === 0) {
                    ...
                    fetch('../retail_html/result_seed_vegetable_template.html')
