...
{
	printf("QUERIES_2\n");
	printf("Entrée dans la fonction queries_plant_vegetable !\n");
	...
	char query_plant[4095] = "SELECT name_vegetable, variety_vegetable, latin_name_vegetable, origine_plant, price_plant, quantity_stock, month_gathering, month_cultivation, floor_type, quantity_sun_need, quantity_water_need "
                   "FROM vegetable "
	...
	while ((row = mysql_fetch_row(result)))
	{
		...
		printf("Fetched data: %s, %s, %s, %s, %f, %d, %s, %s, %s, %s, %s\n",
            ...
            price_plant, quantity_stock, month_gathering, month_cultivation,
