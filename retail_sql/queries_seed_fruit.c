...
{
	printf("QUERIES_2\n");
	printf("Entrée dans la fonction queries_seed_fruit !\n");
	...
	char query_seed[4095] = "SELECT name_fruit, variety_fruit, latin_name_fruit, origine_seed, price_seed, quantity_stock, month_gathering, month_cultivation, floor_type, quantity_sun_need, quantity_water_need "
                   "FROM fruit "
